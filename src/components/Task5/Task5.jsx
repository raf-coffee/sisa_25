  ...
  return (
    <Task title={"Задание 5. Настройка SSH"}>
      ...
      <SubTask machine={"HQ-SRV"}>
        <Item content='echo "Port 2024" >> /etc/openssh/sshd_config && echo "AllowUsers sshuser" >> /etc/openssh/sshd_config && echo "MaxAuthTries 2" >> /etc/openssh/sshd_config && echo "Banner /etc/ban" >> /etc/openssh/sshd_config echo "Authorized access only!" >> /etc/ban' />
